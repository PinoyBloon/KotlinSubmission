...
class Hero {
    ...
    fun duduk() {
        checkHealth()
        println("$name sedang duduk, kecapean")
        health += 1
    }

    fun lari() {
        checkHealth()
        println("$name sedang berlari, dikejar kucing oyen!")
        health -= 2
    }

    fun makan() {
        checkHealth()
        println("$name sedang makan, laper katanya")
        health += 2
    }

    fun minum() {
        checkHealth()
        println("$name sedang minum, haus katanya")
        health += 2
    }

    fun lompat() {
        checkHealth()
        println("$name sedang melompat, awas kena pohon!")
        health -= 2
    }
